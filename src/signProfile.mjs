...
app.put('/signup', (req, res) => {
    ...
    Email.findOne({ email: req.body.email, password: req.body.password }, (err, data) => {
...
app.put('/follow', (req, res) => {
    ...
    Follow.findOneAndUpdate({ username: req.body.username },
        {
            $set: {
...
app.put('/chat', (req, res) => {
    ...
    Chat.findOneAndUpdate({ from: req.body.from, to: req.body.to },
        {
            $set: {
...
app.put('/post', (req, res) => {
    ...
    Post.findOneAndUpdate({ id: req.body.id },
        {
            $set: {
