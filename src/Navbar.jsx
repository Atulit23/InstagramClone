...
export default function Navbar() {
    ...
    return (
        <main>
            ...
            {posts == true &&
                <>
                    <div className="posts__close" onClick={() => {
                        setPosts(!posts)
